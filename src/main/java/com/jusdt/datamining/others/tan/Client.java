package com.jusdt.datamining.others.tan;
...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format("类别为%s所求得的概率为%s", "PlayTennis=No", classResult1));
		System.out.println(String.format("类别为%s所求得的概率为%s", "PlayTennis=Yes", classResult2));
